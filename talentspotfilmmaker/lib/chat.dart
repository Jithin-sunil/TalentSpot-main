    ...
    try {
      final response = await supabase
          ...
          .match({
            ...
            'chat_tocid': widget.userId,
          })
          .or(
            'chat_fromcid.eq.${widget.userId},chat_tofid.eq.${widget.filmmakerId}',
          )
            ...
            setState(() {
              final filteredMessages =
                  snapshot.where((message) {
                    return (message['chat_fromfid'] == widget.filmmakerId &&
  ...
  Future<void> sendMessage() async {
    ...
    try {
      await supabase.from('tbl_chat').insert({
        'chat_fromfid': widget.filmmakerId, // Filmmaker sends message
        'chat_fromcid': null,
        'chat_tocid': widget.userId, // To user (caretaker)
        'chat_tofid': null,
